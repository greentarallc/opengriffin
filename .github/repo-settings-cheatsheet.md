...
```
ai, agent, claude, anthropic, telegram-bot, llm, oss, apache2, python, mcp, model-context-protocol, personal-assistant, self-hosted, byo-key, autonomous-agents, openai, gemini, deepseek, agentic, hermes-alternative
```
